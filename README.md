...
For those who are concerned this type of thinking might lead to even more short-sightedness among investors, I think it is worth mentioning that a portfolio applying these allocation rules would not lead to the kind of frequent trading many disapprove of. Rather, at least as applied in this project, it would shift an investor's portfolio twice every economic cycle. To me, this hardly qualifies as the kind of trading passive investors so often disparage. 
